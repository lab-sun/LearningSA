...
import os
import random
from custom_dataset import PF_Pascal,PF_Willow
...
parser.add_argument('--test_csv_path', type=str, default='./data/bbox_test_pairs_pf.csv', help='directory of## test csv file')
parser.add_argument('--test_image_path', type=str, default='./data/PF-dataset/', help='directory of test data')
...
best_weights = torch.load("./weights/best_checkpoint_willow.pt")
...
with torch.no_grad():
    ...
    for i, batch in enumerate(test_loader):
        ...
        if vis:
            name = "./vision_sa_willow/" + str(i) + "tgt.jpg"
        ...
        if vis:
            name = "./vision_sa_willow/" + str(i) + "scr.jpg"
        ...
        # if vis:
        #     name = "./vision_sa_willow/" + str(i) + "warped_src.jpg"
        ...
        # if vis:
        #     name = "./vision_sa_willow/" + str(i) + "warped_tgt.jpg"
        ...
        if vis:
            name = "./vision_sa_willow/" + str(i) + "scr_keypoints.jpg"
            cv2.imwrite(name, src_var_image_numpy_RGB)
        # else:
