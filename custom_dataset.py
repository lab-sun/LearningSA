...
class Pascal_Seg_Synth(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return {'image1_rgb': transforms.ToTensor()(image1), 'image2_rgb': transforms.ToTensor()(image2),
                ...
                'image1_points': point_A_coords, 'image2_points': point_B_coords,
...
class PF_Pascal(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image1, image1_size = self.get_image(self.image_A_names, idx)
        image2, image2_size = self.get_image(self.image_B_names, idx)
        ##print('111111111111111',cv2.imread('renren.jpeg'))
        ##print('222222222222222',np.array(image2))
        ##cv2.imwrite("image2.jpg", np.array(image2))
        #print('image1',image1)
        #image1.save("./image1.jpeg")
        class_num = int(self.class_num[idx])-1
        image1_var = self.transform(image1)
        #image1_var_pil=transforms.ToPILImage()(image1_var).convert('RGB')
        #image1_var_pil.save("./image1_var_pil.jpeg")
        #image1_var_cv=np.array(image1_var_pil)
        #cv2.imwrite("image1_var_cv.jpg", image1_var_cv)
        image2_var = self.transform(image2)
        ...
        return {'image1_rgb': transforms.ToTensor()(image1), 'image2_rgb': transforms.ToTensor()(image2),
                'image1_var_rgb': image1_var, 'image2_var_rgb':image2_var,
                'image1': self.normalize(image1_var), 'image2': self.normalize(image2_var),
